...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      character*3 flag
      character*77 inputstr,file9,fheader,file14,file15,file16
...
c default settings for CTParam and CTOption cccccccccccccccccccccccccccccc
      ...
      CTParam(74)=0.0d0
      CTPStrg(74)='scaling for x-section for non-leading string hadrons'
      CTParam(75)=1.0d0
      CTPStrg(75)='Lower cutoff for pressure calculation in hydro [e0]'
      CTParam(76)=38.87108d0
      CTPStrg(76)='parameter 1 for QMD-EoS'
      CTParam(77)=17.718260d0
      CTPStrg(77)='parameter 2 for QMD-EoS'
      CTParam(78)=-3.973820d0
      CTPStrg(78)='parameter 3 for QMD-EoS'
      CTParam(79)=-0.315d0
      CTPStrg(79)='parameter 4 for QMD-EoS'
      CTParam(80)=0.26843d0
      CTPStrg(80)='parameter 5 for QMD-EoS'
      CTParam(81)=-0.04072d0
      CTPStrg(82)='parameter 6 for QMD-EoS'
      CTParam(82)=0.00203d0
      CTPStrg(82)='parameter 7 for QMD-EoS'
      CTParam(83)=1.14288d0
      CTPStrg(83)='minimum distance in potential initialization'
...
c   Currently, 84 CTPs are written.
cc
      CTOption(1)=0  
      ...
      CTOption(60)=0
      CTOStrng(60)=' use a 20 perc isotropic x-section in inelast coll'
      CTOption(61)=0
      CTOStrng(61)=' no inelastic N+N scattering'
      CTOption(62)=0
      CTOStrng(62)=' perform resonance decays before each output step'
      CTOption(63)=0
      CTOStrng(63)=' Use tabulated CMF EoS for QMD evolution,>2=mom dep'
c     2: Mom dep. but only use proton pot. for all baryons, 3: Use
c     Id-dependent mom dependence, 4: Use also anti-particle potentials      
      CTOption(64)=0
      CTOStrng(64)=' output nuclei from coalesence in f13 and OSCAR out'
      CTOption(65)=0
      CTOStrng(65)=' Use parametrized EoS for QMD evolution'
      CTOption(66)=0
      CTOStrng(66)=' Include mesons in Coulomb potentials'
      CTOption(67)=0
      CTOStrng(67)=' Energy cut for counting participants in elastic'
      CTOption(68)=0
      CTOStrng(68)=' Reconstruct resonances for f13 output'
...
c constraints for skyrme pots:
      if(eos.ne.0.and.((srtflag.eq.0.and.ebeam.gt.21.0d0)
     &             .or.(srtflag.eq.1.and.srtmax.gt.32.3d0)
     &             .or.(srtflag.eq.2.and.pbeam.gt.11.9))) then
